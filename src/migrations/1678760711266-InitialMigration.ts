...
export class InitialMigration1678760711266 implements MigrationInterface {
    name = 'InitialMigration1678760711266'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "real_estate" ("id" SERIAL NOT NULL, "value" numeric(12,2) NOT NULL DEFAULT '0', "size" integer NOT NULL, "sold" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "addressId" integer, "categoryId" integer, CONSTRAINT "REL_44ae17efa35575b6a6f83b35ee" UNIQUE ("addressId"), CONSTRAINT "PK_8735a23fd5adc2afb18242894ff" PRIMARY KEY ("id"))`);
